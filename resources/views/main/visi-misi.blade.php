...
@section('content')
    <div class="text-center mb-5">
        <h1 class="fw-bold text-primary">Visi & Misi</h1>
        <p class="text-muted">Program Studi Software Engineering - Universitas Pignatelli Triputra</p>
    </div>
       
     <section class="mb-3 py-4 bg-light">
        <h2 class="text-center text-primary">Visi</h2>
        <p>Program studi yang unggul dalam bidang rekayasa perangkat lunak, berorientasi global, menjunjung tinggi nilai-nilai integritas dan bersemangat kebhinekaan.</p>
           <h2 class="text-center text-primary">Misi</h2>
        <ul>
